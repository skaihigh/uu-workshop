  ...
  return (
    <div className="claims">
      ...
      <ul className="disc-list">
        <li>
          Vi kjenner alle som skal bruke systemet, og er sikre på at det ikke er
          noen som har nedsatt funksjonsevne
        </li>
        <li> Blabla</li>
      </ul>
      <h3>
      ...
      <ul className="disc-list">
        ...
        <li>
          ...
          hen da ikke kan bruke systemet - og det er ikke lovlig! - eller så må
          man uansett endre på systemet
        </li>
        <li>Blabla</li>
      </ul>
    </div>
