export function TrappedByKeyboard(): JSX.Element {
  return (
    <div className="trapped-by-keyboard">
      ...
      '<strong>Keyboard trap</strong>': Umulig å navigere videre fra et element
      ved å bare bruke keyboardet.
      <br />
      <br />
      ...
      <pre>
        &lt;a <br /> href="#" <br /> onKeyDown=&#123;(event) =&gt; &#123; <br />{' '}
        event.preventDefault(); <br /> window.open("https://miles.no",
        "_blank"); <br /> &#125;&#125; <br />
        &gt; <br /> Haha! <br />
        &lt;/a&gt;
      </pre>
      ...
      <div>
        <div>
          ...
          fordi <code>onKeyDown</code>-eventet er satt til å ikke gjøre
          noenting.
        </div>
        <br />
        <a href="#">Lenke 1</a>
        <a href="#" onKeyDown={(event) => event.preventDefault()}>
          Lenke 2
        </a>
        <a href="#">Lenke 3</a>
      </div>
      <pre>
        &lt;a href="#" onKeyDown=&#123;(event) =&gt;
        event.preventDefault()&#125;&gt;Lenke 2&lt;/a&gt;
      </pre>
      <br />
      <br />
      <div>
        <div>
          ...
          fordi <code>onBlur</code>-eventet til feltet 'Mellomnavn' brukes til å
          sette fokus på seg selv.
        </div>
        <br />
        <div>
      ...
      <pre>
        ...
        &lt;input <br /> id="input2" <br /> type="text" <br />{' '}
        onBlur=&#123;(event) =&gt; &#123; <br /> event.preventDefault(); <br />{' '}
        event.target.focus(); <br /> &#125;&#125; <br />
        /&gt;
      </pre>
      <br />
    </div>
